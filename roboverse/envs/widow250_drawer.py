...
class Widow250DrawerEnv(Widow250Env):
    ...
    def get_info(self):
        ...
        # print("info['drawer_opened_percentage']", info['drawer_opened_percentage'])
...
class Widow250DrawerRandomizedEnv(Widow250DrawerEnv):
    ...
    def __init__(self,
                 drawer_position_low = (0.75, 0.15, -.35),
                 drawer_position_high = (0.45, 0.15, -.35),
                 **kwargs):
        self.drawer_position_low = drawer_position_low
        self.drawer_position_high = drawer_position_high
        self.points = [
                    [self.drawer_position_low[0], self.drawer_position_low[1], -0.37],
                    [self.drawer_position_high[0], self.drawer_position_low[1], -0.37],
                    [self.drawer_position_high[0], self.drawer_position_high[1], -0.37],
                    [self.drawer_position_low[0], self.drawer_position_high[1], -0.37],
                ]
    ...
    def set_drawer_pos_and_quat(self):
        ...
        # print(drawer_positions)

        drawer_position = np.random.uniform(low=self.drawer_position_low, high=self.drawer_position_high)
        drawer_position = tuple(drawer_position)
        mid_x_pos = (self.drawer_position_low[0]+self.drawer_position_high[0])/2
        left_opening = int(drawer_position[0]<mid_x_pos)

        print(drawer_position, left_opening)
        # exit()
