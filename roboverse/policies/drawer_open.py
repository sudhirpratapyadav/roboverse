...
class DrawerOpen:
    ...
    def get_action(self):
        ...
        # print('gripper_dist_thresh', self.gripper_dist_thresh)
        # print('gripper_handle_xy_dist', gripper_handle_xy_dist)
        # print('gripper_xy_dist_thresh', self.gripper_xy_dist_thresh)
        # print('self.ending_height_thresh', self.ending_height_thresh)
        # print('np.abs(ee_pos[2] - self.ending_height_thresh)', np.abs(ee_pos[2] - self.ending_height_thresh))
        # print('')
        ...
        if (gripper_handle_xy_dist > self.gripper_xy_dist_thresh
            ...
            x_command = (-1) ** (1 - self.env.left_opening) * self.xyz_action_scale
