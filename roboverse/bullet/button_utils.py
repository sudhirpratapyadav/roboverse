...
def get_button_cylinder_pos(button):
    button_cylinder_pos, _ = bullet.get_link_state(button, 0)
    # print("---------------------------")
    # print('button pose:', button_cylinder_pos)
    print('\n\n')
...
def get_button_cylinder_joint(button):
    ...
    button_cylinder_joint_idx = joint_names.index('base_to_head_joint')
