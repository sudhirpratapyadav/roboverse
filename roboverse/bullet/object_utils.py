...
def check_grasp(object_name,
    ...
    object_height = object_pos[2]
    success = False
    # print(f'check_grasp1: {object_height}, {grasp_success_height_threshold}')
    if object_height > grasp_success_height_threshold:
        ee_pos, _ = get_link_state(
            robot_id, end_effector_index)
        object_gripper_distance = np.linalg.norm(
            object_pos - ee_pos)
        # print(f'check_grasp2: {object_gripper_distance}, {grasp_success_object_gripper_threshold}')
...
def generate_object_positions(object_position_low, object_position_high,
    ...
    print(f'object_position_low {object_position_low}')
    print(f'object_position_high{object_position_high}')
...
def load_object(object_name, object_position, object_quat, scale=1.0):
    ...
    print(shapenet_obj_path_map.keys())
    print(BULLET_OBJECT_SPECS.keys())
    if object_name in shapenet_obj_path_map.keys():
        ...
        # print("object not found name:", object_name)
        # print('shapenet: ', shapenet_obj_path_map.keys())
        # print('bullet obj: ', BULLET_OBJECT_SPECS.keys())
